...
<body onload="listaRepositorio('ordenar');">
...
<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/1-Normal-Home-icon.png" class="alineadoTextoImagenCentro" border="0"/>&nbsp;&nbsp;<a href="auditorias.php" class="nounderline">Inicio</a>&nbsp;&nbsp;>>&nbsp;&nbsp;<img src="img/Search-file-icon3.png" class="alineadoTextoImagenCentro" border="0"/>&nbsp;<a href="auditorias.php" class="nounderline">Auditorias</a>&nbsp;&nbsp;>>&nbsp;&nbsp;<img src="img/archive-icon3.png" class="alineadoTextoImagenCentro" border="0"/><strong>&nbsp;Repositorio Auditoria</strong>
<br>	

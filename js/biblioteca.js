...
function creaDocumento(){
  ...
  var codigo = document.getElementById("codigoFuncionario").value.toUpperCase();
  var daincar = document.getElementById("daincar").value;
  //if(tipoDocumento==30){
  ...
  objHttpXMLCargaDatos.send("nomDocumento="+nomDocumento+"&descDocumento="+descDocumento+"&archivo="+archivo+"&extension="+extension+"&tipoDocumento="+tipoDocumento+"&otroInforme="+otroInforme+"&codigo="+codigo+"&daincar="+daincar);
...
function eliminaBilioteca(codigo,documento)
{
	...
	if (msj){
	var codigoUsuario = document.getElementById("codigoUsuario").value.toUpperCase();
  var daincar = document.getElementById("daincar").value;
  ...
  objHttpXMLCargaDatos.open("GET","./objeto/deleteDocumentoBiblioteca.php?codigo="+codigo+"&documento="+documento+"&codigoUsuario="+codigoUsuario+"&daincar="+daincar);

...
var Servidor="./objeto/objAutocompletarNombre.php"; // Determina la pagina donde buscar
...
function autocompletarNombre(idContenido2,Cadena)
{
...
function selectItem2(idContenido2,value,cod)
{
	...
	autocompletarNombre(idContenido2,value);
}

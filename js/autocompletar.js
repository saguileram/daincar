...
var Servidor="./objeto/objAutocompletar.php"; // Determina la pagina donde buscar
...
function selectItem(idContenido,value,cod)
{
	...
	document.getElementById("txtEstamento").value=value;
	document.getElementById("txtCodEstamento").value=cod;

...
function creaCarpeta(){
  ...
  objHttpXMLCargaDatos.send("codAuditoria="+codAuditoria+"&nomAuditoria="+nomAuditoria+"&annoAuditoria="+annoAuditoria+"&estamento="+estamento+"&tipoAuditoria="+tipoAuditoria+"&cantHallazgo="+cantHallazgo+"&usuario="+usuario+"&daincar="+daincar);
...
//alert(ordenar);
  ...
  objHttpXMLCargaDatos.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
   ...
   objHttpXMLCargaDatos.send(encodeURI("ordenar="+ordenar+"&perfil="+perfil));
...
function creaDocumento(){
	...
	var msj=confirm("PROCEDERA A CREAR UN DOCUMENTO EN LA CARPETA: "+carpeta+" \n\u00BFDESEA CONTINUAR?...");
	if (msj){
  ...
  var tipoDocumento = document.getElementById("cboTipoInforme").value;
  ...
  objHttpXMLCargaDatos.open("POST","./objeto/insertDocumento.php",true);
  
  objHttpXMLCargaDatos.setRequestHeader("Content-Type","application/x-www-form-urlencoded");

  objHttpXMLCargaDatos.send("codAuditoria="+codAuditoria+"&nomDocumento="+nomDocumento+"&descDocumento="+descDocumento+"&archivo="+archivo+"&extension="+extension+"&tipoDocumento="+tipoDocumento+"&otroInforme="+otroInforme+"&usuario="+usuario+"&daincar="+daincar);
...
function listaDocumento()
{
  ...
  objHttpXMLCargaDatos.open("POST","./objeto/listaDocumento.php",true);
  
  objHttpXMLCargaDatos.setRequestHeader("Content-Type","application/x-www-form-urlencoded");

   //objHttpXMLCargaDatos.send();
  
   objHttpXMLCargaDatos.send(encodeURI("codAuditoria="+codAuditoria+"&perfil="+perfil));
   //alert(codAuditoria);
   //alert("A\u00F1o: "+anno);
   //alert("Mes: "+mes);
...
function eliminaDocumento(carpeta,documento)
{
	
	//var anno= document.getElementById("anno").value;
	//var mes 	= document.getElementById("mes").value;
		var msj=confirm("PROCEDER\u00C1 A ELIMINAR EL DOCUMENTO "+documento+" DE LA CARPETA "+carpeta+" \n\u00BFDESEA CONTINUAR?...");
	if (msj){
	var usuario  = document.getElementById("codigoUsuario").value;
	var daincar 	= document.getElementById("daincarUsuario").value;
  ...
  objHttpXMLCargaDatos.open("GET","./objeto/deleteDocumento.php?carpeta="+carpeta+"&documento="+documento+"&usuario="+usuario+"&daincar="+daincar);
    ...
    if(objHttpXMLCargaDatos.readyState == 4)
    {
      ...
      if (objHttpXMLCargaDatos.responseText != "ERROR")
      {
        ...
        divPagina.innerHTML=xml;
            ...
            alert("EL DOCUMENTO "+documento+ " DE LA CARPETA " +carpeta+" \nHA SIDO ELIMINADO CON EXITO ......        ");
...
function validarFichaDocumento(){
  ...
  //alert(archivo);
	...
	//}
		...
		document.getElementById("cboTipoInforme").focus();
		return false;
	}
...
function guardarFichaDocumento(){
...
function limpiaFichaDocumento(){	
  ...
  document.getElementById("cboTipoInforme").value=0;
...
function eliminaCarpeta(carpeta)
{
  ...
  objHttpXMLCargaDatos.open("GET","./objeto/deleteCarpeta.php?carpeta="+carpeta+"&usuario="+usuario+"&daincar="+daincar);
...
//alert(anno);
  ...
  objHttpXMLCargaDatos.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
   ...
   objHttpXMLCargaDatos.send(encodeURI("estamento="+estamento+"&nombre="+nombre+"&tipo="+tipo+"&anno="+anno+"&usuario="+usuario+"&daincar="+daincar));

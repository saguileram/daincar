...
<body onload="datoCarpeta('txtCodigoAuditoria');">
    ...
    <section class="form_wrap">
        ...
        <section class="cantact_info">
            <section class="info_title">
                ...
                <h2>MODIFICA DATOS <br>REPOSITORIO</h2>
            </section>
        ...
        <form action="" class="form_contact">
        	<!--<a href="javascript:void(0);"</a><img src="img/Programming-Delete-Sign-icon.png" border="0" align="right" onClick="window.close();"/></a><br>-->
            <h2><center>Modificaci&oacute;n de Carpeta</centrer></h2>
            <div class="user_info">
                <label for="names">C&oacute;digo de la Auditoria *</label>
                <input type="text" id="txtCodigoAuditoria" name="txtCodigoAuditoria" style="text-transform:uppercase;" value="<?php echo $codigoAuditoria=base64_decode($_GET["cod"]);?>" readonly>
  ...
  <option value="2019">2019</option>
                ...
                <input type="text" id="txtEstamento" name="texto" size="50" onKeyUp="autocompletar('lista',this.value);" onFocus="limpia(this);"><input type="hidden" id="txtCodEstamento" name="texto2"/><div id="lista" class="autocompletar"></div>
  ...
  <option value="30">EXTRAORDINARIA</option>
        ...
        <label for="phone">Cantidad de Hallazgos *</label>
           <input type="text" id="txtCantidadHallazgo" onkeypress="return validaNumeros(event)">
              <input type="button" value="Modificar carpeta" id="btn100" onClick="modificaFichaCarpeta()" <?php if($tipo==30) echo "disabled"; else echo "enabled";?>>
            </div>
        </form>

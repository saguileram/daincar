...
<script src="js/autocompletarNombre.js" type="text/javascript" language="javascript"></script>
...
<body onload="comboEstamento('txtEstamento');">
...
<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/1-Normal-Home-icon.png" class="alineadoTextoImagenCentro" border="0"/>&nbsp;&nbsp;<a href="auditorias.php" class="nounderline">Inicio</a>&nbsp;&nbsp;>>&nbsp;&nbsp;<img src="img/Search-file-icon3.png" class="alineadoTextoImagenCentro" border="0"/>&nbsp;<a href="auditorias.php" class="nounderline">Auditorias</a>&nbsp;&nbsp;>>&nbsp;&nbsp;<img src="img/Distributor-report-icon3.png" class="alineadoTextoImagenCentro" border="0"/><strong>&nbsp;Reportes</strong>
<br>
...
<table id="consulta"  border="1" cellspacing="0" cellpadding="1" align="center" bordercolor="#F1F1F1">			
	  ...
	  <tr align="left" class="tabla" height="30">
		<td class="Tabla-Titulo" >&nbsp;&nbsp;
	     ...
	     <td class="Tabla-Titulo" >&nbsp;&nbsp;
	     	 <input type="text" id="txtNombre" name="texto2" size="50" onKeyUp="autocompletarNombre('listaNombre',this.value);" onFocus="limpia(this);"><input type="hidden" id="txtCodNombre" name="texto3"/><div id="listaNombre" class="autocompletarNombre"></div>
  ...
  <option value="2020">2020</option>
	  ...
	  <tr align="center" class="tabla" height="30">
		<td colspan="2" bgcolor="">
		  <input type="button" name="button02" id='btnSend' value="Buscar Auditoria"  onClick="consultarRepositorio();"> 
	     </td>

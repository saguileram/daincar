...
<script src="js/repositorio.js" type="text/javascript" language="javascript"></script>
				...
				<div class="form-holder">
					...
					<form id="frm_contact" name="frm_contact" action="" method="post">
						...
						<div class="field">
							...
							<div class="inputs">
								<input class="aweform small" type="text" id="txtCodigoAuditoria" name="txtCodigoAuditoria" value="<?php echo $codigoAuditoria=base64_decode($_GET["cod"]);?>" readonly/>
							</div>  
						</div>
						...
						<div class="field">
							...
							<div class="inputs">
									<select class="aweform" id="cboTipoInforme" name="subject" onChange="muestraCampo()" <?php if($tipo==30) echo "disabled"; else echo "enabled";?>>
  ...
  <option value="60">OTRO</option>
						...
						<div class="field">
							...
							<input class="aweform" type="text" id="descripcionDocumento" name="phone" style="text-transform:uppercase;" onKeyDown="validarSubir();" <?php if($tipo==30) echo "disabled"; else echo "enabled";?>/>
							</div>  
						</div>
						...
						<div class="field">
							...
							<div class="inputs">
								...
								<input type="hidden" id="carpeta" value="<?php echo $codigoAuditoria=base64_decode($_GET["cod"]);?>"/>

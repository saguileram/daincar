...
<link rel="stylesheet" href="css/fichaEquipo.css" type="text/css" media="all"/>
  ...
  <div id="divAsignaAnimales" style="position:relative;  width:100%;">
		<div id="marcoLevantado">
		  <div id="cuadro">
			...
			<tr> 
			 	<td align="left">
					<input type="text" id="auditoria" value="<?php echo base64_decode($auditoria);?>" disabled/><input type="hidden" id="asignado" value="<?php echo base64_decode($asignado);?>" />  
			</td>
			<td>&nbsp;</td>
			</tr>
			</table>
...
<td width="8%"><input type="button" id="btn100" value="ASIGNAR EQUIPO"  onclick="guardarFichaEquipo();" <?php if($tipo==30) echo "disabled"; else echo "enabled";?>/><input type="hidden" name="grabar" value="si"></td>
